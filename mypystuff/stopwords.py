...
#---------------------------------------#
# list courtesy of http://armandbrahaj.blog.al/2009/04/14/list-of-english-stop-words/
#---------------------------------------#

LIST = ['a', 'about', 'above', 'above', 'across', 'after', 'afterwards', 'again', 'against', 'all', \
...
def notstopword(token, l = LIST):
	"""Return True in token is stop word

	:param token: the token to test
	:param l: the list of stop words
	:type token: string
	:type l: list of strings or None
	:rtype: bool
	"""
	return token not in l
